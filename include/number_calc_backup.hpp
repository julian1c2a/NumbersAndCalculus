...
// Usar namespace de traits para simplicidad
 ...
 */
template <signed_integral T, integral U>
 ...
 */
template <unsigned_integral T, integral U>
 ...
 */
template <integral T, integral U> constexpr T int_power_2(U exp) noexcept {
  if (exp == 0)
    return T{1};
...
/*
template<boost_integral T, integral U>
 ...
 */
template <integral T> constexpr bool int_power_safe(T base, T exp) noexcept {
  if (exp == 0)
